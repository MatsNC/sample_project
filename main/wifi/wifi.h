...
typedef struct
{
    ...
    uint32_t received_data7;
    uint32_t received_data8; 
    uint32_t received_data9;  
} touch_data_t;
...
extern char touch_status[30]; 

extern char touch_val[350]; /**< Buffer to store the received touch value as a string. */
